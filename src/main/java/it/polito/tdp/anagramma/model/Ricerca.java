...
public class Ricerca {
	...
	private void cerca(String parziale, int livello, List<Character> disponibili) {
		...
		// caso normale
		// provare ad aggiungere alla soluzione parziale tutti i caratteri presenti tra
		// i disponibili
 ...
 * una parte dell'anagramma già costruito (i primi caratteri). 
 * Livello: numero di lettere di cui è composta la souzione parziale. 
 ...
 * scegliendola tra quelle che non sono ancora state utilizzate (nella soluzione parziale).
 */